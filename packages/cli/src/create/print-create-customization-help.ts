...
export function printCreateCustomizationHelp(): void {
  ...
  const customizationExplanation = [
    `Files that are generated by ${chalk.cyan("coat")} will be continuously kept up to date via your ${chalk.cyan("coat")} template.`,
    `This means that you can't edit these files directly, because they will be overwritten when running ${chalk.cyan("coat sync")}.`,
    "",
    `However, ${chalk.cyan("coat")} allows you to customize the final file by creating a ${chalk.green("<filename>-custom.js")} file next to the file you want to customize.`,
    "",
    `As an example, a configuration file named ${chalk.green("config.json")} can be customized by placing a ${chalk.green("config.json-custom.js")} file next to it.`,
